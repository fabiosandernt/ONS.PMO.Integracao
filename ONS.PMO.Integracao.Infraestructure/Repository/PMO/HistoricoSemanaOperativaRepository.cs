...
{
    public class HistoricoSemanaOperativaRepository : Repository<HistoricoModificacaoSemanaOperativa>, IHistoricoSemanaOperativaRepository
    {
        public HistoricoSemanaOperativaRepository(WebPmoContext context) : base(context)
        {
        }
    }
}
