...
namespace ONS.PMO.Integracao.Api
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            .AddService(serviceName: "ONS.PMO.Integracao.Api", serviceVersion: "1.0.0").AddTelemetrySdk();
            ...
            builder.Services.AddOpenTelemetry()
                .WithMetrics(builder =>
                {
                    ...
                    .AddConsoleExporter()
                    .AddOtlpExporter(exporter => { exporter.Protocol = OpenTelemetry.Exporter.OtlpExportProtocol.HttpProtobuf; });
                })
                .WithTracing(builder =>
                {
